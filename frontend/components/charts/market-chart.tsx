...
export function MarketChart({ ticker, pinMode, pins, onBarClick, onViewChange, onDataChange }: Props) {
  ...
  return (
    <div>
      ...
      >
        {error && (
          <div className="flex h-[347px] items-center justify-center px-6 text-center font-mono text-[12px] text-warn">
            {error}
          </div>
        )}
        {!error && !n && !loading && (
          <div className="flex h-[347px] items-center justify-center font-mono text-[12px] text-ink-4">
