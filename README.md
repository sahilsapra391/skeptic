...
![tests](https://img.shields.io/badge/tests-1%2C179%20passing-brightgreen)
...
backend/
  ...
  tests/           1,066 tests, engine fixtures hand-computed
...
**1,179 tests** (1,066 backend, 113 collector).
