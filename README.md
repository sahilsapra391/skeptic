...
![tests](https://img.shields.io/badge/tests-1%2C188%20passing-brightgreen)
...
backend/
  ...
  tests/           1,075 tests, engine fixtures hand-computed
...
**1,188 tests** (1,075 backend, 113 collector).
