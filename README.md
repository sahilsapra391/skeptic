...
![tests](https://img.shields.io/badge/tests-1%2C198%20passing-brightgreen)
...
backend/
  ...
  tests/           1,085 tests, engine fixtures hand-computed
...
**1,198 tests** (1,085 backend, 113 collector).
