...
![tests](https://img.shields.io/badge/tests-1%2C116%20passing-brightgreen)
...
backend/
  ...
  tests/           1,003 tests, engine fixtures hand-computed
...
**1,116 tests** (1,003 backend, 113 collector).
