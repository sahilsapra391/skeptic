...
![tests](https://img.shields.io/badge/tests-1%2C125%20passing-brightgreen)
...
backend/
  ...
  tests/           1,012 tests, engine fixtures hand-computed
...
**1,125 tests** (1,012 backend, 113 collector).
