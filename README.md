...
![tests](https://img.shields.io/badge/tests-1%2C200%20passing-brightgreen)
...
backend/
  ...
  tests/           1,087 tests, engine fixtures hand-computed
...
**1,200 tests** (1,087 backend, 113 collector).
